...
const Auth = () => (
  <Stack.Navigator initialRouteName="LoginScreen">
    ...
    <Stack.Screen name="RegisterForm2" component={RegisterForm2} options={{ headerShown: false }} />

    <Stack.Screen name="RegisterForm3" component={RegisterForm3} options={{ headerShown: false }} />

    <Stack.Screen name="RegisterForm4" component={RegisterForm4} options={{ headerShown: false }} />
  </Stack.Navigator>
);
