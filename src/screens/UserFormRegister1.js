...
const UserFormRegister1 = (props) => {
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} >
            <div>
                <p>   
                    <label>Qual o seu Nome? </label><p></p>
                    <input
                        type="text"
            ...
            <div>
                <p>
                    <label>Género </label><p></p>
                    <label>
                        <input type="radio" name="gender" id="fem" value="Feminino" ref={register} /> Feminino
                        <input type="radio" name="gender" id="mas" value="Masculino" ref={register} /> Masculino
                        <input type="radio" name="gender" id="out" value="Outro" ref={register} /> Outro
